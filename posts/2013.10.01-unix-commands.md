...
- [Basics](#basics)
	- [What directory am I currently in?](#what-directory-am-i-currently-in)
	- [How can I see what's in this directory?](#how-can-i-see-whats-in-this-directory)
	- [Moving around](#moving-around)
	- [Displaying content of a file](#displaying-content-of-a-file)
...
- [Find (searching for files)](#find-searching-for-files)
    - [Finding files over a certain size](#finding-files-over-a-certain-size)
...
- [Piping I/O](#piping-io)
	...
	- [Sequences and Parallelism](#sequences-and-parallelism)
- [Processes](#processes)
    - [Viewing processes](#viewing-processes)
    - [Moving processes between the fore/background](#moving-processes-between-the-forebackground)
