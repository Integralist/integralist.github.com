...
Well here we are again to learn some more refactoring techniques. If you want to recap the other techniques then go [read my previous post](/posts/refactoring-techniques/), otherwise let's just crack on...
...
Imagine you implemented the "[Introduce Named Parameter](/posts/refactoring-techniques/#introduce-named-parameter)" technique (passing a hash with named properties as a single argument instead of multiple unidentified arguments). 
...
You can also use this technique to help ease creating properties on an object. For example, I used this technique in my [MVCP](/posts/mvcp-model-view-controller-presenter/) blog post to dynamically create instance variables... 
