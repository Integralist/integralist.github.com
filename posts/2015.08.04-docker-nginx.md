...
<!--language-bash-->
    ...
    curl -I http://$(boot2docker ip):32781/test.html
...
> Note: in the following example you'll need to get the dynamically allocated port number for the nginx container. You can do this by running `docker ps` and extracting the port number from there
