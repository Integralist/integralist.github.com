...
If you're interested in understanding thread safety (and the different concurrency abstractions) in more detail then I recommend you take a read of the following article "[Thread Safe Concurrency](http://www.integralist.co.uk/posts/concurrency/)".
...
![Bad Architecture](/../../assets/images//bad-architecture.png)
...
![Better Architecture](/../../assets/images//chintz-specification.png)
...
![Better Architecture](/../../assets/images//rpm-libraries.png)
...
Immutability is the key to avoiding complex mutexes and semaphores when writing multi-threaded code. To find out more on the subject please take a read of ["Thread Safe Concurrency"](http://www.integralist.co.uk/posts/concurrency/).
