...
So for this particular algorithm example, the worst case number of operations is `4`. Take a look at our earlier explanation of Logarithms if you're unsure why that is (in a non-abstract sense this would look like: `O(Log2(12))`).
